...
const uebersetzungen = {
  ...
  de: {
    ...
    leistungen_titel: "Was du im Coaching bekommst",
    leistungen_text: "Du bekommst nicht einfach nur einen Plan, sondern persönliche Unterstützung, klare Struktur und regelmäßige Anpassungen.",
    leistung1_titel: "Individueller Trainingsplan",
    leistung1_text: "Ein Plan, der zu deinem Ziel, deinem Alltag und deinem Trainingslevel passt.",
    leistung2_titel: "Ernährungsstrategie",
    leistung2_text: "Alltagstaugliche Ernährung ohne extreme Diäten oder unnötige Verbote.",
    leistung3_titel: "Regelmäßige Check-ins",
    leistung3_text: "Wir prüfen deine Fortschritte und passen deinen Plan an, wenn es nötig ist.",
    leistung4_titel: "WhatsApp-Support",
    leistung4_text: "Du kannst Fragen stellen und bekommst Unterstützung, wenn du sie brauchst.",
    leistung5_titel: "Motivation & Verantwortung",
    leistung5_text: "Du bleibst leichter dran, weil du nicht mehr alleine durchziehen musst.",
    leistung6_titel: "Anpassung bei Plateaus",
    leistung6_text: "Wenn es stagniert, finden wir gemeinsam heraus, was geändert werden muss.",
},
  ...
  en: {
    ...
    leistungen_titel: "What you get in coaching",
    leistungen_text: "You do not just get a plan, but personal support, clear structure and regular adjustments.",
    leistung1_titel: "Individual training plan",
    leistung1_text: "A plan that fits your goal, your daily routine and your training level.",
    leistung2_titel: "Nutrition strategy",
    leistung2_text: "Practical nutrition without extreme diets or unnecessary restrictions.",
    leistung3_titel: "Regular check-ins",
    leistung3_text: "We review your progress and adjust your plan whenever needed.",
    leistung4_titel: "WhatsApp support",
    leistung4_text: "You can ask questions and get support when you need it.",
    leistung5_titel: "Motivation & accountability",
    leistung5_text: "It becomes easier to stay consistent because you no longer have to do it alone.",
    leistung6_titel: "Adjustments during plateaus",
    leistung6_text: "If progress stalls, we figure out together what needs to change.",
},
  ...
  ru: {
    ...
    leistungen_titel: "Что ты получаешь в коучинге",
    leistungen_text: "Ты получаешь не просто план, а личную поддержку, понятную структуру и регулярные корректировки.",
    leistung1_titel: "Индивидуальный план тренировок",
    leistung1_text: "План, который подходит твоей цели, твоему распорядку и уровню подготовки.",
    leistung2_titel: "Стратегия питания",
    leistung2_text: "Практичное питание без экстремальных диет и ненужных запретов.",
    leistung3_titel: "Регулярные проверки прогресса",
    leistung3_text: "Мы отслеживаем твой прогресс и при необходимости корректируем план.",
    leistung4_titel: "Поддержка в WhatsApp",
    leistung4_text: "Ты можешь задавать вопросы и получать поддержку, когда она нужна.",
    leistung5_titel: "Мотивация и ответственность",
    leistung5_text: "Тебе легче оставаться дисциплинированным, потому что ты больше не один.",
    leistung6_titel: "Корректировки при застое",
    leistung6_text: "Если прогресс останавливается, мы вместе разбираем, что нужно изменить.",
}
